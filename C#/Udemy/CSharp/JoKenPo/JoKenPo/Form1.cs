...
namespace JoKenPo
{
    public partial class Form1 : Form
    {
        ...
        {
            labelResultado.Visible = false; //Deixa o ? invisivel ao iniciar o jogo
            Game jogo = new Game();
            ...
            switch (jogo.Jogar(opcao))
            {
                case Game.Resultado.Ganhar:
                    ...
                    goto default; //Manda para o default, onde mostra as imagens de ambos
                ...
                case Game.Resultado.Empatar:
                    ...
                    goto default;
                default:
                    pictureBox1.Image = jogo.ImgJogador; //Inseri a imagem no box de cima com as escolhas do jogador e PC
