...
namespace FormControle
{
	...
	{
		Label label1; // Declarado de forma global
		Button btn1;
		public Form1()
		{
			InitializeComponent();
		...
		{
			label1 = new Label();  // Criação de um controle manualmente de uma label
			...
			btn1 = new Button();  //Criação de um controle de button
			btn1.Location = new Point(240, 371);
			btn1.Size = new Size(230, 67);
